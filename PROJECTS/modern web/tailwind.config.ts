...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(135deg, #8B5CF6, #06B6D4, #F59E0B)',
        ...
        'gradient-disney': 'linear-gradient(135deg, #667eea 0%, #764ba2 50%, #06B6D4 100%)',
        'gradient-hero': 'linear-gradient(135deg, rgba(102, 126, 234, 0.9) 0%, rgba(118, 75, 162, 0.9) 50%, rgba(6, 182, 212, 0.9) 100%)',
      },
      backdropBlur: {
        xs: '2px',
      },
